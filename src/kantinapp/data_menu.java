...
Object tabel;
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                .addComponent(combo_kode_kategori, javax.swing.GroupLayout.Alignment.TRAILING, 0, 278, Short.MAX_VALUE)
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        ...
        String kode_menu = tableModel.getValueAt(row, 0).toString();
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        try {
           ...
           Files.copy(source.toPath(), dest.toPath(), StandardCopyOption.REPLACE_EXISTING);
            ...
            Statement stt = kon.createStatement();
            Timestamp waktuSekarang = new Timestamp(new Date().getTime());
            String kodeUnik = kode_generator.generate_kode("MN", 5);
